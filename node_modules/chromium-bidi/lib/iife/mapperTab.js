...
/**
	 ...
	 * @license
	 */
Object.defineProperty(a,"__esModule",{value:!0});const Pn=r,Rn=Ir,kn=l,En=jr,_n=yn,Tn=bn;(0,_n.generatePage)();const Nn=new Tn.WindowBidiTransport,jn=new Tn.WindowCdpTransport,On=new Rn.CdpConnection(jn,_n.log);async function Mn(e){console.log("Launching Mapper instance with selfTargetId:",e);const t=await Pn.BidiServer.createAndStart(Nn,On,await On.createBrowserSession(),e,new En.BidiParser,_n.log);return(0,_n.log)(kn.LogType.debugInfo,"Mapper instance has been launched"),t}return window.runMapperInstance=async e=>{await Mn(e)},window.setSelfTargetId=async e=>{(await Mn(e)).emitOutgoingMessage(Pn.OutgoingMessage.createResolved({launched:!0}),"launched")},a}();
